...
public class League
{
    ...
    public League(String filename)
    {
        teams = new ArrayList<>();
        fixtures = new ArrayList<>();
        FileIO namesList = new FileIO(filename);
        for(String s: namesList.getLines())
        {
            teams.add(s);
        }
    }
    ...
    public static void main(String [] args) {
        ...
        System.out.print("Enter .txt file: ");
        String txtfile = user_input.next();
        League league1 = new League(txtfile);
